...
(() => {
  ...
  // node_modules/snapser-dissonity/node_modules/cross-fetch/dist/browser-ponyfill.js
  var require_browser_ponyfill = __commonJS({
    "node_modules/snapser-dissonity/node_modules/cross-fetch/dist/browser-ponyfill.js"(exports, module) {
  ...
  // node_modules/snapser-dissonity/dist/index.mjs
  ...
  async function initializeSdk(options) {
    ...
    user.bot = false;
    return { discordSdk, user, access_token: data.access_token };
  }
  async function receiveMessage(discordSdk, user, access_token, messageData) {
    ...
    switch (command) {
      ...
      case "GET_ACCESS_TOKEN": {
        if (access_token == null)
          throw new Error("You need to be authenticated to get the current access_token");
