...
namespace Snapser.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://gateway-accel.snapser.com/znxemg5b";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://gateway-accel.snapser.com/znxemg5b"},
        ...
        public Configuration(
            ...
            string basePath = "https://gateway-accel.snapser.com/znxemg5b") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: bot-one: v2 SDK\n";
